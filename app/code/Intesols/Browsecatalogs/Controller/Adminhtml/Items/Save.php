...
class Save extends \Intesols\Browsecatalogs\Controller\Adminhtml\Items
{
    ...
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
				...
				$imageFile = $objectManager->create('Intesols\Browsecatalogs\Helper\Data')->uploadFile('file', $model);
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('intesols_browsecatalogs/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('intesols_browsecatalogs/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('intesols_browsecatalogs/*/new');
                }
                return;
            } catch (\Exception $e) {
