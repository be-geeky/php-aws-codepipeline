...
class Reseller extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function toArray()
    {
		...
		$RDCollection = $RDCollection->getCollection()->addFieldToFilter('type', array('eq' => 1))->load();
		$list = [];
