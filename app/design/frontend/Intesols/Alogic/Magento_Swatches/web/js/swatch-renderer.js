    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderSwatchSelect: function (config, chooseText) {
            ...
            $.each(config.options, function () {
                ...
                html += '<option class="hi" ' + attr + '>' + label + '</option>';
            });
        ...
        _ProductMediaCallback: function ($this, response) {			
			if(response.sku){				
				jQuery("#distributor-main-container:hidden .owl-item:hidden").each(function(){					
					//alert($(this).text())
					//console.log(jQuery(this).find("span").html());
					var searchSring = jQuery(this).find("span").html();
					searchSring = searchSring.replace("{{sku}}",response.sku);
					//console.log(searchSring);
					jQuery(this).find("a").attr('href',searchSring);
				});
				jQuery("#reseller-main-container:hidden .owl-item:hidden").each(function(){
					var searchSring = jQuery(this).find("span").html();
					searchSring = searchSring.replace("{{sku}}",response.sku);					
					jQuery(this).find("a").attr('href',searchSring);
				});
				jQuery(".product.attribute.sku .value").html(response.sku);
			}
